...
export const CATEGORIES: Category[] = [
  { key: "LIEU", label: "Lieu", plural: "Lieu", group: "Lieu & réception" },
  { key: "TRAITEUR", label: "Traiteur", plural: "Traiteur", group: "Lieu & réception" },
  { key: "GATEAU", label: "Gâteau", plural: "Gâteau", group: "Lieu & réception" },
  { key: "PHOTOGRAPHE", label: "Photographe", plural: "Photographe", group: "Prestataires" },
  { key: "VIDEASTE", label: "Vidéaste", plural: "Vidéaste", group: "Prestataires" },
  ...
  { key: "ROBE", label: "Tenues", plural: "Tenues", group: "Tenues & beauté" },
  { key: "COIFFURE", label: "Coiffure & maquillage", plural: "Coiffure", group: "Tenues & beauté" },
...
export const CATEGORY_LABEL: Record<string, string> = {
  ...
  ROBE: "Tenues",
  COSTUME: "Costume",
  COIFFURE: "Coiffure & maquillage",
  MAQUILLAGE: "Maquillage",
  ALLIANCES: "Alliances",
  ACCESSOIRES: "Accessoires",
  PAPETERIE: "Papeterie",
  SITE_INVITES: "Site & invités",
